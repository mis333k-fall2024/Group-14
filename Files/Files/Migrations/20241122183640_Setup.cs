        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountMinStay = table.Column<int>(type: "int", nullable: false),
                    UnavailableDates = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Properties_Categories_CategoriesCategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_Properties_PropertiesPropertyID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextReview = table.Column<string>(type: "nvarchar(280)", maxLength: 280, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_AppUsersId",
                table: "Properties",
                column: "AppUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_CategoriesCategoryID",
                table: "Properties",
                column: "CategoriesCategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_AppUsersId",
                table: "Reservations",
                column: "AppUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_PropertiesPropertyID",
                table: "Reservations",
                column: "PropertiesPropertyID");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_AppUsersId",
                table: "Reviews",
                column: "AppUsersId");
